...
@section('title', '限时抢购管理')

@section('content')
    @include('admin.limitBuy.add')
    @include('admin.limitBuy.edit')
        ...
        <div class="page-container">
            ...
            <div class="cl pd-5 bg-1 bk-gray mt-20">
                <span class="btn btn-primary radius" data-toggle="modal" data-target="#addModel"><i
                            class="Hui-iconfont">&#xe600;</i> 添加抢购</span>
                        ...
                        @foreach($lists as $k => $v)
                            <tr class="text-c">
                                ...
                                <td id="orderBy" data-id="{{ $v->id }}"
                                    data-url="{{ route('admin.limit.buy.order') }}"
...
@endsection
@section('javascript')
    <script type="text/javascript" src="{{ asset('/admin/js/limitBuy.js') }}"></script>
