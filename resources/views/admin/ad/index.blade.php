    ...
    <div class="Hui-article">
        <div class="page-container">
            ...
            <div class="cl pd-5 bg-1 bk-gray mt-20">
                <span class="l">
                    <a href="{{ route('admin.ad.add') }}" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i>添加广告</a>
                </span>
                            ...
                            <tr class="text-c">
                                ...
                                <td class="f-14">
                                    <button id="editShowModel" class="btn btn-success size-S radius"
                                            data-id="{{ $v->id }}"
                                            data-url="{{ route('admin.ad.edit') }}">编辑
                                    </button>
                                    @if($v->status == 2)
                                        <button id="changeStatus" class="btn btn-secondary size-S radius"
                                                data-id="{{ $v->id }}"
                                                data-url="{{ route('admin.ad.status') }}"
