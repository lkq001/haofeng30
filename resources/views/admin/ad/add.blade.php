    ...
    <div class="page-container">
        <div class="Hui-article">
            <form method="post" class="form form-horizontal" id="form-add"
                  data-jump="{{ route('admin.ad.index') }}" action="{{ route('admin.ad.store') }}" >
                {{ csrf_field() }}
                <div class="modal-body">
                    ...
                    <div class="row cl">
                        <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>广告位宽度：</label>
                        <div class="formControls col-xs-8 col-sm-8">
                            <input type="text" class="input-text" value="{{ old('width') }}" placeholder="" name="width"/>
                        </div>
                    </div>

                    <div class="row cl">
                        <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>广告位高度：</label>
                        <div class="formControls col-xs-8 col-sm-8">
                            <input type="text" class="input-text" value="{{ old('height') }}" placeholder="" name="height"/>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <a href="{{ route('admin.ad.index') }}" class="btn btn-default">返回列表</a>
...
@endsection
@section('javascript')
    <script type="text/javascript" src="{{ asset('admin/js/ad.js') }}"></script>
