    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">修改拼团</h4>
            </div>

            <form method="post" class="form form-horizontal" id="form-edit"
                  action="{{ route('admin.teamwork.update') }}">
                {{ csrf_field() }}
                ...
                <div class="modal-body">
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-8">
                            <span class="select-box">
                                <select name="product_warehouse_id" data-url="{{ route('admin.limit.buy.show') }}" id="product_warehouse_id" class="select">
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-8">
                            <input type="text" class="input-text" value="" placeholder="" onkeyup="" name="people_number">
                        </div>
                    </div>
