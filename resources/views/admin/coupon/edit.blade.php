    ...
    <div class="page-container">
        <div class="Hui-article">
            ...
            <form method="post" class="form form-horizontal" id="form-edit"
                  data-jump = "{{ route('admin.coupon.index') }}" action="{{ route('admin.coupon.update') }}" >
                {{ csrf_field() }}
                ...
                <div class="modal-body">
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-4">
                            <input type="text" class="input-text" value="{{ old('buy_total')  ?? $info->buy_total }}" placeholder=""
                                   id="" name="buy_total">
                        </div>
                    </div>
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-4">
                            <input type="text" class="input-text" value="{{ old('relief_price') ?? $info->relief_price }}" placeholder=""
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-4">
                            <input type="text" class="input-text" value="{{ old('start_time') ?? $info->start_time }}" placeholder="" id="start_time" name="start_time">
                        </div>
                    </div>
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-4">
                            <input type="text" class="input-text" value="{{ old('end_time') ?? $info->end_time }}" placeholder="" id="end_time" name="end_time">
                        </div>
                    </div>
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-4">
                            <input type="text" class="input-text" value="{{ old('coupon_num') ?? $info->coupon_num }}" placeholder="" id="coupon_num" name="coupon_num">
                        </div>
                    </div>
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-4">
                            <input type="text" class="input-text" value="{{ old('abstract') ?? $info->abstract }}" placeholder="" id="abstract" name="abstract">
                        </div>
                    </div>
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-4">
                            <input type="text" class="input-text" value="{{ old('introduce') ?? $info->introduce }}" placeholder="" id="introduce" name="introduce">
                        </div>
                    </div>
