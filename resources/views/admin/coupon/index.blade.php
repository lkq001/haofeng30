    ...
    <div class="Hui-coupon">
        <div class="page-container">
            ...
            <div class="cl pd-5 bg-1 bk-gray mt-20">
                <span class="l">
                    <a href="{{ route('admin.coupon.add') }}" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i>添加优惠券</a>
                </span>
                </span>
                            ...
                            <tr class="text-c">
                                ...
                                <td class="f-14">
                                    <button id="editShowModel" class="btn btn-success size-S radius"
                                            data-id="{{ $v->id }}"
                                            data-url="{{ route('admin.coupon.edit') }}">编辑
                                    </button>
