    ...
    <div class="page-container">
        <div class="Hui-article">
            <form method="post" class="form form-horizontal" id="form-add"
                  data-jump = "{{ route('admin.assess.index') }}" action="{{ route('admin.assess.update') }}">
                {{ csrf_field() }}
                ...
                <div class="modal-body">
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-8">
                            <input type="hidden" id="uploadOld" value="{{ $info->getThumbs ?? [] }}"/>
                    ...
                    <div class="row cl">
                        ...
                        <div id="content" style="display:none">{{  $info->getContent->content ?? '' }}</div>
                    </div>
