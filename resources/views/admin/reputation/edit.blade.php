    ...
    <div class="page-container">
        <div class="Hui-article">
            <form method="post" class="form form-horizontal" id="form-edit"
                  data-jump = "{{ route('admin.reputation.index') }}" action="{{ route('admin.reputation.update') }}">
                {{ csrf_field() }}
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-8">
                            <textarea name="content" id="content" class="input-text" id="" cols="30" rows="10"
                                      style="min-height: 100px;resize: vertical;">{{ $info->content }}</textarea>
                        </div>
                    </div>

                </div>
                <div class="modal-footer">
                    <a href="{{ route('admin.reputation.index') }}" type="button" class="btn btn-default" data-dismiss="modal">返回列表</a>
