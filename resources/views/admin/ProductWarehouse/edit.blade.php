    ...
    <div class="page-container">
        <div class="Hui-article-index">
            <form method="post" class="form form-horizontal" id="form-add"
                ...
                {{ csrf_field() }}
                <input type="hidden" name="id" value="{{ $productWarehouse->id }}">
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>商品名称：</label>
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="{{  $productWarehouse->name }}" placeholder=""
                               name="name">
                    </div>
                </div>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text w25" value="{{  $productWarehouse->price }}" placeholder=""
                               id="" name="price">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="{{  $productWarehouse->description }}"
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text w25" value="{{  $productWarehouse->order_by }}"
                               placeholder=""
                ...
                <div id="content" style="display:none">{{  $productWarehouse->getHasOneContent->content }}</div>
